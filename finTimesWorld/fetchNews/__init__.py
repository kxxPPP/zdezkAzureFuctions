...
def fetch_ft_world_headlines():
    try:
        logging.info('Fetching FT world headlines.')
        ...
        logging.error(f'Error in fetch_ft_world_headlines: {e}')
        raise
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        headlines_data = fetch_ft_world_headlines()
